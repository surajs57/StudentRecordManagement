...
<form  class="regForm" action="" method="post">
  ...
  <div class="tab">TEACHER:
      <p><input name="tuserid" type="text" class="inputvalues" style="width:48%;padding:7px;margin:0 auto;" placeholder="Teacher ID"/required></p>

    <p><input name="tname" type="text" class="inputvalues" style="width:48%;padding:7px;margin:0 auto;" placeholder="Full Name"/required></p>
    <p><input name="temail" type="text" class="inputvalues" style="width:48%;padding:7px;margin:0 auto;" placeholder="Email"/required></p>
	<p><input name="tcontact" type="text" class="inputvalues" style="width:48%;padding:7px;margin:0 auto;" placeholder="Contact"/required></p>
	<p><input name="tsemester" type="text" class="inputvalues" style="width:48%;padding:7px;margin:0 auto;" placeholder="Semester"/required></p>
	<p><input name="tsubjectcode" type="text" class="inputvalues" style="width:48%;padding:7px;margin:0 auto;" placeholder="Subject Code"/required></p>
    <p><input name="tpassword" type="password" class="inputvalues" style="width:35%;padding:7px;margin:0 auto;color:#42729B;" placeholder="Password"/ required></p>
...
$subject=$_POST['tsubjectcode'];
$password=$_POST['tpassword'];
		$query2="insert into teacher values('$userid','$name','$email','$contact','$semester','$subject')";
		$query3="insert into login values('$userid','$password','teacher')";
$run2=mysqli_query($con,$query2);
$run3=mysqli_query($con,$query3);

if($run2 && $run3)
{
	echo '<script type="text/javascript">alert("Teacher Data Successfully Registered!")</script>';
}
else
	{
	echo '<script type="text/javascript">alert("Failed!")</script>';
